...
// // Function to populate the checkout list
...
// // Event listener to remove items from the checkout list
...
// // Initialize the checkout list
// document.addEventListener('DOMContentLoaded', () => {
//     populateCheckout();
// });

// // Event listener for the clear button in the checkout modal
// document.querySelector('.clear-cart').addEventListener('click', clearCart);

// // Checkout functionality
// document.querySelector('.checkout-cart').addEventListener('click', proceedToPayment);


//======================================================================

//let coffeeData = JSON.parse(localStorage.getItem('cartItems')) || [];
//Retrieve items from localStorage
let checkoutItems = JSON.parse(localStorage.getItem('checkoutItems')) || [];
